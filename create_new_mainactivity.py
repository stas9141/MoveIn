...
def create_new_mainactivity():
    # Read the clean file
    with open('app/src/main/java/com/example/movein/MainActivity.kt', 'r') as f:
        content = f.read()
    ...
    content = re.sub(
        r'(Screen\.Settings,\s*)(is Screen\.TaskDetail,)',
        r'\1Screen.MyApartment,\n        \2',
        content
    )
